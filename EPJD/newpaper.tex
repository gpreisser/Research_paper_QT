...
\author{Guillermo Preisser \and  Pablo Barberis-Blostein}
 \mail{guillermo.preisser@uabc.edu.mx}

%\offprints{}
 \institute{Instituto de Investigaciones en Matem\'aticas Aplicadas y en
   Sistemas, Universidad Nacional Aut\'onoma de M\'exico, Ciudad
...
\titlerunning{Correlations in an atom inside a leaky driven cavity}
\maketitle
